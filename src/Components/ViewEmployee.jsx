...
const ViewEmployee = () => {
  ...
  return (
    <div className="viewemployee container mt-5 mx-auto  ">
      <div className="head bg-purple-800 h-16 flex justify-between items-center px-5">
        <div className="detailHed left text-2xl font-semibold text-white ">
          <span className="appname-full">
            Details of employee id: {employee.id}
          </span>
          <span className="appname-short">Id: {employee.id}</span>
        </div>

        <div className=" text-xl justify-center items-center text-white font-semibold">
          <Link
            className="bg-green-500 px-2 rounded-sm text-center font-semibold text-xl flex items-center"
            to="/"
          >
